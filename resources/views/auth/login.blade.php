    ...
    <section class="section">
      <div class="d-flex flex-wrap align-items-stretch">
        <div class="col-lg-4 col-md-6 col-12 order-lg-1 min-vh-100 order-2 bg-white">
          <div class="p-4 m-3">
            <img src="{{ asset('assets/themes/stisla/img/stisla-fill.svg') }}" alt="logo" width="80" class="shadow-light rounded-circle mb-5 mt-2">
            <h4 class="text-dark font-weight-normal">Selamat Datang <span class="font-weight-bold">Stisla</span></h4>
            ...
            <form method="POST" action="#" class="needs-validation" id="login-form" novalidate="">
              ...
              <div class="form-group text-right">
                ...
                <button type="submit" class="login-btn btn btn-primary btn-lg btn-icon icon-right" tabindex="4">
                  Login
                </button>
              </div>
      ...
      if (email.value != '' && password.value != '') {
        ...
        .then(res => {
          if (res.error) {
            ...
            setTimeout(() => {
              txtInfo.innerHTML = '<i class="fa fa-spin fa-spinner"></i> Mengalihkan...';
            }, 3000);
